                ...
                <tbody>
                  {group.items.map((a) => (
                    <TableRow key={a.id} className={verticalRowClass(a.program)}>
                      <Td>
                        <AmbassadorNameLink id={a.id}>{a.fullName}</AmbassadorNameLink>
                      </Td>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {group.items.map((a) => (
              <button
                ...
                type="button"
                onClick={() => onEdit(a)}
                className="group overflow-hidden rounded-xl border border-hairline bg-white text-left shadow-soft transition-shadow hover:shadow-elev"
              >
                <div
              ...
              >
                <div className="mb-2 flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <AmbassadorNameLink id={a.id} className="truncate text-sm" stopPropagation>
                      {a.fullName}
                    </AmbassadorNameLink>
